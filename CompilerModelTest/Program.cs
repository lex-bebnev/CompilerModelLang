...
namespace CompilerModelTest
{
    public class Program
    {
        static void Main(string[] args)
        {
            ...
            //var stream = new AntlrInputStream("{ \n\r\tdim a,b integer; \n\r\tdim c real; \n\r\ta as 3; \n\r\t; \n\r\tc as b; \n\r\twrite(a = 3); \n\r\tread(b); \n\r\tc as b;\n\r}");
            var stream = new AntlrInputStream("{dim a integer; dim b real; dim d,c boolean; d as false; c as true; write(d<>c); a as 10; b as 1; while a>0 do { a as a-1; write(a);} for a as 0; to a=10 do { a as a + 1; write(a);}}");//  d as 2.0;  write(c/d); read(a); read(b); read(c); write(c); write(a,b); write(c/c); write(a);}");
